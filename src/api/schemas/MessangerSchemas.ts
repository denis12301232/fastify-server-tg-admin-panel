...
export class MessangerSchemas {
   ...
   static readonly createGroupQuery = {
      querystring: Joi.object<MessangerTypes.CreateGroupQuery>().keys({
   ...
   static readonly updateGroupQuery = {
      querystring: Joi.object<MessangerTypes.UpdateGroupQuery>().keys({
         group_id: Joi.string().required(),
   ...
   static readonly getUserChatByIdQuery = {
      querystring: Joi.object<MessangerTypes.GetUserChatByIdQuery>().keys({
         chat_id: Joi.string().required()
      }).required()
   }
