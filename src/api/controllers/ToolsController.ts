...
export class ToolsController {
   ...
   static async setGoogleServiceAccountSettings(request: FastifyRequest<{ Body: ToolsTypes.SetGoogleServiceAccountSettingsBody }>) {
   ...
   static async setAvatar(this: FastifyInstance, request: FastifyRequest, reply: FastifyReply) {
